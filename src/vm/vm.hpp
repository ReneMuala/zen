...
`--------'`------'`--'  `--'  )";
    enum instruction
    {
        ...
        DECL_KAIZEN_STRING_CONVERSION_FOR_TYPE(i8),
        DECL_KAIZEN_CONVERSION_FOR_TYPE(i16),
        DECL_KAIZEN_STRING_CONVERSION_FOR_TYPE(i16),
        DECL_KAIZEN_CONVERSION_FOR_TYPE(i32),
        DECL_KAIZEN_STRING_CONVERSION_FOR_TYPE(i32),
        DECL_KAIZEN_CONVERSION_FOR_TYPE(i64),
        DECL_KAIZEN_STRING_CONVERSION_FOR_TYPE(i64),
        DECL_KAIZEN_CONVERSION_FOR_TYPE(f32),
        DECL_KAIZEN_STRING_CONVERSION_FOR_TYPE(f32),
        DECL_KAIZEN_STRING_CONVERSION_FOR_TYPE(f64),
        ...
        copy,
        /// walk <pointer:i64> <item:i64> advance pointer in offset bytes storing the new address in destination.
        refer,
        placeholder,
    };
    class vm
