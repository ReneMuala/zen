...
TEST(composer_unit, write_string)
{
    ...
    composer->end();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code, (std::vector<i64>{hlt,most, -8, refer, -8, -24, 8, write_str, -8, -24, -32, most, 8, ret,}));
}
...
TEST(composer_unit, print_string)
{
    ...
    composer->call("write", 2, composer::call_result::pushed);
    composer->end();
    auto _p = (i64)composer->_pool.get<i64>(reinterpret_cast<i64>(stdout)).get();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code, (std::vector<i64>{hlt,most, -8, refer, -8, -24, 8, write_str, -8, -24, -32, most, 8, ret, push_i64, _p, push_i64, -16, call, 1, most, 16, ret,}));
}
...
TEST(composer_unit, print_string_2)
{
    ...
    composer->call("print", 1, composer::call_result::pushed);
    composer->end();
    auto _p = (i64)composer->_pool.get<i64>(reinterpret_cast<i64>(stdout)).get();
    auto _p2 = (i64)composer->_pool.get<zen::types::heap::string*>(zen::types::heap::string::from_string("hello world")).get();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code, (std::vector<i64>{hlt,most, -8, refer, -8, -24, 8, write_str, -8, -24, -32, most, 8, ret, push_i64, _p, push_i64, -16, call, 1, most, 16, ret, most, -8, call, 0, push_i64, -8, push_i64, _p2, call, 0, most, 16, push_i64, -8, call, 14, most, 8, push_i64, -8, call, 0, most, 8, most, 8, ret,}));
}
...
TEST(composer_unit, sum_ints_as_doubles)
{
    ...
    composer->push("x");
    composer->call("double", 1, composer::call_result::pushed);
    composer->push("y");
    composer->call("double", 1, composer::call_result::pushed);
    composer->plus();
...
TEST(composer_unit, cast_int_to_double)
{
    ...
    composer->call("double", 1, composer::call_result::assignment);
    composer->end();
...
TEST(composer_cast, cast_byte_to_byte) {
    ...
    composer->call("byte", 1, composer::call_result::assignment);
    composer->end();
...
TEST(composer_cast, cast_byte_to_bool) {
    ...
    composer->call("bool", 1, composer::call_result::assignment);
    composer->end();
...
TEST(composer_cast, cast_byte_to_short) {
    ...
    composer->push("x");
    composer->push<zen::i8>(42, "byte");
    composer->call("short", 1, composer::call_result::assignment);
    composer->end();
    auto _p = (i64)composer->_pool.get<zen::i8>(42).get();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code,
...
TEST(composer_cast, cast_byte_to_int) {
    ...
    composer->push("x");
    composer->push<zen::i8>(42, "byte");
    composer->call("int", 1, composer::call_result::assignment);
    composer->end();
    auto _p = (i64)composer->_pool.get<zen::i8>(42).get();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code,
...
TEST(composer_cast, cast_byte_to_long) {
    ...
    composer->push("x");
    composer->push<zen::i8>(42, "byte");
    composer->call("long", 1, composer::call_result::assignment);
    composer->end();
    auto _p = (i64)composer->_pool.get<zen::i8>(42).get();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code,
...
TEST(composer_cast, cast_byte_to_float) {
    ...
    composer->push("x");
    composer->push<zen::i8>(42, "byte");
    composer->call("float", 1, composer::call_result::assignment);
    composer->end();
    auto _p = (i64)composer->_pool.get<zen::i8>(42).get();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code,
...
TEST(composer_unit, ternary) {
    ...
    composer->end();
    EXPECT_EQ(dynamic_cast<const zen::composer::vm::composer*>(composer.get())->code,
        (std::vector<i64>{hlt, most, -4, go_if_not, -13, 5, i32_to_i32, -4, -21, go, 3, i32_to_i32, -4, -17, i32_to_i32, -25, -4, most, 4, ret,}));
}
...
TEST(composer_unit, overloading)
{
    ...
    composer->push<i64>(1, "long");
    composer->push("sum");
    composer->call("sum", 2, composer::call_result::pushed);
